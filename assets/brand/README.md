...
Use only the assets in this directory for public OLAF surfaces.
...
[`docs/brand-guidelines.md`](../../docs/brand-guidelines.md). Asset origin and
rights are recorded in [`PROVENANCE.md`](PROVENANCE.md).

These are the only approved public design assets. Design tokens, working
files, and superseded variants are intentionally kept outside the published
repository.
